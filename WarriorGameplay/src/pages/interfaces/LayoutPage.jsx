...
const LayoutPage = ({ level, hintText }) => {
  ...
  useEffect(() => {
    ...
    if (!endTime) {
      endTime = new Date().getTime() + 60 * 60 * 100 * 25
  ...
  return (
    <div className="flex items-center justify-center">
      <div className="flex justify-center items-center">
        <div className="z-10 absolute w-52 h-14 top-8 flex justify-center items-center rounded-full text-3xl bg-white text-white bg-opacity-20 backdrop-filter backdrop-blur-[3px] border-[1px]">
          LEVEL {level}
        </div>
      </div>
      <div className="flex justify-center items-center">
        ...
        <div className="z-10 absolute w-52 h-14 bottom-8 flex justify-center items-center rounded-full text-3xl bg-white text-white bg-opacity-20 backdrop-filter backdrop-blur-[3px] border-[1px]">
          {name}
        </div>
      ...
      {showHintModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white bg-opacity-20 backdrop-filter backdrop-blur-[8px] p-6 rounded-lg border border-white border-opacity-20 max-w-md w-full mx-4">
