...
const Backstory_1 = () => {
    ...
    const firstPassage = `  Raven leads you through the scorched ruins of the stronghold, the world around you swallowed by pitch-black darkness. Together, you cross the borders into Kravaros—a land that was once the heart of Azzgardos, now shrouded in endless shadow As you navigate the desolate landscape, Raven explains that a crucial map lies hidden in Kehmest, a remote stronghold far from the capital—the Palace of Kravaros. Determined, you and Raven launch an assault on Kehmest, facing its defenses to retrieve the map that holds the key to your mission.`;

    const secondPassage = `  After studying the map, Raven's expression hardens. He turns to you and says, "This map… it feels like a trap. Something about it doesn’t sit right." He pauses, then adds, "I know a shorter route—one that bypasses the dangers this map might lead us into. Trust me; we can save time and avoid falling into their hands."
With Raven's instincts guiding you, a crucial decision lies ahead: follow the map’s uncertain path or follow your fellow Elitos he suggests.`;
