...
const Backstory_Level_1_1 = lazy(() => import('./pages/backstory/Backstory_Level_1_1'))
const Backstory_Level_1_2 = lazy(() => import('./pages/backstory/Backstory_Level_1_2'))
const Backstory_Level_1_3 = lazy(() => import('./pages/backstory/Backstory_Level_1_3'))
const Level_1 = lazy(() => import('./pages/levels/Level_1'))
const Backstory_Level_1A = lazy(() => import('./pages/backstory/Backstory_Level_1A'))
const Level_1A = lazy(() => import('./pages/levels/Level_1A'))
const Backstory_Level_2 = lazy(() => import('./pages/backstory/Backstory_Level_2'))
const Level_2 = lazy(() => import('./pages/levels/Level_2'))
const Backstory_Level_3 = lazy(() => import('./pages/backstory/Backstory_Level_3'))
const Level_3 = lazy(() => import('./pages/levels/Level_3'))
const Backstory_Level_4 = lazy(() => import('./pages/backstory/Backstory_Level_4'))
const Options_Level_4 = lazy(() => import('./pages/options/Options_Level_4'))
const Backstory_Level_4A = lazy(() => import('./pages/backstory/Backstory_Level_4A'))
const Level_4A = lazy(() => import('./pages/levels/Level_4A'))
const Backstory_Level_5A = lazy(() => import('./pages/backstory/Backstory_Level_5A'))
const Backstory_Level_6_1 = lazy(() => import('./pages/backstory/Backstory_Level_6_1'))
const Level_6_1 = lazy(() => import('./pages/levels/Level_6_1'))
const Backstory_Level_7_1 = lazy(() => import('./pages/backstory/Backstory_Level_7_1'))
...
const Backstory_Level_5B = lazy(() => import('./pages/backstory/Backstory_Level_5B'))
const Level_5B = lazy(() => import('./pages/levels/Level_5B'))
const Options_Level_5B = lazy(() => import('./pages/options/Options_Level_5B'))
const Backstory_Level_6_2 = lazy(() => import('./pages/backstory/Backstory_Level_6_2'))
    ...
    <Router>
      <Routes>
        <Route path="/" element={<Common />}>
          ...
          <Route path="/backstory_level_2" element={<Backstory_Level_2 />} />
          ...
          <Route path="/options_level_7A" element={<ProtectedRoute level={"options_level_7a"} element={<Options_Level_7A/>} />} />
