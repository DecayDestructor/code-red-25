    ...
    <Router>
      <Routes>
        <Route path="/" element={<Common />}>
          ...
          />          
          <Route path="/level_1" element={<ProtectedRoute level={"level_1"} element={<Level_1 />} />} />

          <Route path="/backstory_level_1A" element={<ProtectedRoute level={"level_1a"} element={<Backstory_Level_1A />} />}  />
          <Route path="/level_1A"  element={<ProtectedRoute level={"level_1a"} element={<Level_1A />} />} />

          <Route path="/backstory_level_2" element={<ProtectedRoute level={"level_2"} element={<Backstory_Level_2 />} />} />
          <Route path="/level_2" element={<ProtectedRoute level={"level_2"} element={<Level_2 />} />} />

          <Route path="/backstory_level_3" element={<ProtectedRoute level={"level_3"} element={<Backstory_Level_3/>} />}  />
          <Route path="/level_3" element={<ProtectedRoute level={"level_3"} element={<Level_3/>} />} />

          <Route path="/backstory_level_4" element={<ProtectedRoute level={"options_level_4"} element={<Backstory_Level_4/>} />}  />
          <Route path="/options_level_4" element={<ProtectedRoute level={"options_level_4"} element={<Options_Level_4/>} />} />
          <Route path="/backstory_level_4A" element={<Backstory_Level_4A level={"level_4a"} element={<Level_4A/>} />}  />
          <Route path="/level_4A" element={<ProtectedRoute level={"level_4a"} element={<Level_4A/>} />} />

          <Route path="/backstory_level_5A" element={<ProtectedRoute level={"level_5a"} element={<Backstory_Level_5A/>} />} />
          <Route path="/backstory_level_5B" element={<ProtectedRoute level={"level_5b"} element={<Backstory_Level_5B/>} />}  />
          ...
          <Route path="/backstory_level_6_2" element={<ProtectedRoute level={"level_6_2"} element={<Backstory_Level_6_2/>} />}  />
          <Route path="/level_6_2" element={<ProtectedRoute level={"level_6_2"} element={<Level_6_2/>} />} />

          <Route path="/backstory_level_7_1" element={<ProtectedRoute level={"level_7_1"} element={<Backstory_Level_7_1/>} />} />
          <Route path="/level_7_1" element={<ProtectedRoute level={"level_7_1"} element={<Level_7_1/>} />} />
          <Route path="/options_level_7A" element={<Options_Level_7A />} />
          <Route  path="/backstory_level_7_1A" element={<ProtectedRoute level={"level_7_1a"} element={<Backstory_Level_7_1A/>} />} />
          <Route path="/105_99_104_111_114_102_111_110_105_97_115" element={<ProtectedRoute level={"level_7_1a"} element={<Level_7_1A/>} />} />
          <Route path="/jumpscare_7_1A" element={<ProtectedRoute level={"jumpscare_7_1a"} element={<Jumpscare_7_1A/>} />} />

          <Route path="/backstory_level_7_1B"  element={<ProtectedRoute level={"level_7_1b"} element={<Backstory_Level_7_1B />} />}  />
          <Route path="/level_7_1B" element={<ProtectedRoute level={"level_7_1b"} element={<Level_7_1B />} />} />
          <Route path="/backstory_level_7_3" element={<ProtectedRoute level={"level_7_3"} element={<Backstory_Level_7_3/>} />}  />

          <Route path="/level_7_3" element={<ProtectedRoute level={"level_7_3"} element={<Level_7_3/>} />} />
          <Route path="/level_7_4" element={<ProtectedRoute level={"level_7_4"} element={<Level_7_4/>} />}  />
