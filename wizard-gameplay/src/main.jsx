  ...
  <StrictMode>
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/level2" element={<ProtectedRoute level={"level2"} element={<Level2 />} />} />
        <Route path="/level2_puzzle" element={<ProtectedRoute level={"level2"} element={<Level2_Puzzle />} />} />

        <Route path="/level3" element={<ProtectedRoute level={"level3"} element={<Level3 />} />}  />
        <Route path="/level3_puzzle"  element={<ProtectedRoute level={"level3"} element={<Level3_Puzzle />} />} />

        <Route path="/level4" element={<ProtectedRoute level={"level4"} element={<Level4/>} />} />
        <Route path="/level4_puzzle" element={<ProtectedRoute level={"level4"} element={<Level4_Puzzle />} />} />


        <Route path="/level5" element={<ProtectedRoute level={"level5"} element={<Level5 />} />}  />

        <Route path="/level6" element={<ProtectedRoute level={"level6"} element={<Level6 />} />}  />
        <Route path="/level6_puzzle" element={<ProtectedRoute level={"level6"} element={<Level6_Puzzle />} />}  />

        <Route path="/level7_1" element={<ProtectedRoute level={"level7_1"} element={<Level7_1pre />} />}  />
        <Route path="/level7_1_puzzle" element={<ProtectedRoute level={"level7_1"} element={<Level7_1 />} />}  />

        <Route path="/level7_2pre" element={<ProtectedRoute level={"level7_2"} element={<Level7_2pre />} />}/>
        <Route path="/level7_2" element={<ProtectedRoute level={"level7_2"} element={<Level7_2 />} />}  />
