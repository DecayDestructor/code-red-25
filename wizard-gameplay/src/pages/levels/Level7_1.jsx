...
const Level7_1 = () => {
  ...
  const script = "U29tZXRoaW5nIGxvc3QgaXMgc29tZXRoaW5nIGdhaW5lZA=="; //Something lost is something gained
  ...
  return (
    <>
      <div className="w-screen min-h-screen h-full bg-stone-950 overflow-x-hidden">
