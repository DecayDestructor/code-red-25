...
const Level7_1 = () => {
  const level7_1_texts = [
    ...
    `A hidden 'spell' encoded 64 bases high shall guide you to defeating the most strongest human alive. Once you shall unlock the hidden spell, another secret command must be chanted so that you can finally SET Malevoryx to die.`,
  ...
  const handleTextComplete = () => {
    dispatch(lockLevel('level6'))
    navigate('/level7_1_puzzle')
  }
