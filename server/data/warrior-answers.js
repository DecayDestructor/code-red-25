const warriorAnswers = {
  1: [
    ...
    'PARTHENON,GREECE',
    'PARTHENON, GREECE',
  ], // Multiple answers for level 1
  '1A': ['HWIZDPXZY HWMRD GMVKIVH VSG ,VNRG UL HIVKHRSD VSG MR'],
  2: ['tki', 'sgz'], // Multiple answers for level 2
  3: ['Colossalas'],
  '4A': ['Setrayal'],
  '6_1': ['3.7.8.9', '3.1', '4.5'],
  '7_1': ['110011011'],
  '7_1B': ['C86FE9E9CC38771BF90CE8AB26C17806E21305B3E040DD49EF475DC989CD8C67'],
