...
const MedievalCaptcha = () => {
  ...
  // Timer setup for the 10-second challenge
  const time = new Date();
  ...
  return (
    <div className="flex justify-center items-center flex-col h-screen relative">
      {/* Background Image */}
      <img
        src="src/assets/levels/Level_1.png"
        alt="Background"
        className="object-cover w-full h-full absolute z-0"
      />
      <div className="h-[72%] relative p-4 rounded-2xl shadow-[0_0_50px_rgba(255,69,0,0.3)] border-4 border-amber-700 max-w-sm w-full mt-4 mb-4 bg-gray-950 bg-opacity-80 z-10">
        {selectedCategory && (
        ...
        <div className="grid grid-cols-3 gap-1 mb-4">
          ...
          rounded-lg overflow-hidden h-[90%] w-[90%]
