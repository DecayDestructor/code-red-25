...
const App = () => {
    return (
        <div className="flex justify-center items-center flex-col h-screen relative">
            ...
            />
            <LayoutPage />
            <div className="relative flex flex-col items-center justify-center bg-black opacity-75 rounded-2xl p-16 w-[90vw] max-w-7xl h-[70vh] overflow-hidden shadow-[0_0_30px_rgba(255,255,0,0.8)] text-center">
