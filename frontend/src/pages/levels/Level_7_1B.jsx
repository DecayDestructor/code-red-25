...
const BackstoryLevelComponent = () => {
    ...
    // First text passage
    const firstPassage = `  The engineer of Ichorfonias only knows how to operate. Engineer cannot touch the instrument or Malakaroth will get to know about the breach. So he tells Gavin to toggle all the components to a colour that matches the color of the motherboard.`;

    // Second text passage
    const secondPassage = `  In myths of old, I symbolize life,  
    I lie beneath, a realm of hidden might,
    Where circuits connect and power ignites.
    The place where 1’s and 0’s makes sense,
    Who am I?`;
