...
const ColorBoxes = () => {
  ...
  return (
    <div className="flex justify-center items-center flex-col h-screen relative">
      ...
      {/* Main Container */}
      <div className="relative bg-white bg-opacity-50 backdrop-blur-md shadow-xl rounded-xl p-8 w-11/12 sm:w-4/5 lg:w-3/4 text-white z-10">
        {/* Header */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
          {colors.map((color, i) => (
            ...
            >
              <div
                className={`h-48 rounded-xl shadow-lg flex flex-col items-center justify-center p-6
              ...
              >
                {/* Box number */}
                <div className="absolute top-3 left-3 w-8 h-8 rounded-full bg-black bg-opacity-50 
        ...
        <div className="text-center mt-8">
          {showNextPageButton ? (
            <div className="animate-fadeIn">
              <p className="text-xl font-medium mb-4 text-green-600">
