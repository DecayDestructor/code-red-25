...
const App = () => {
  ...
  const handleVerify = () => {
    if (userInput.trim().toUpperCase() === correctTranslation) {
      ...
      setTimeout(() => {
        window.location.href = "nextLevel.html"; // Replace with your next game level file
      }, 1500);
    } else {
  ...
  return (
    <div className="h-screen bg-cover bg-center flex items-center justify-center" style={{ backgroundImage: "url('back.jpg')" }}>
